...
export default {
  ...
  faq: [
    ...
    { q: 'Are the calculators free to use?', a: 'Yes. All five run in the browser with no account or sign-in, they update as you type, and each one records its inputs in the page URL so a specific case can be shared or referenced.' },
  ],
