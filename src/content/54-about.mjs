...
export default {
  ...
  answer: 'GREEN18 is an independent iPhone fantasy football live draft assistant published by Interplore that recalculates player valuations during a live draft according to league settings, roster construction, player availability, draft state, and user preferences. It runs on iPhone only, has no accounts or sign-in, makes no connection to any fantasy platform, and collects no personal data.',
