...
export default {
  ...
  description: 'How eight ideas — scarcity, replacement, opportunity cost, horizon, tiers, roster, format — compose into a single valuation of a player at one pick.',
  ...
  hero: {
    ...
    lede: [
      ...
      'The pages in this section are the parts. Read in order, they describe a single model rather than eight separate ideas.',
    ],
    cta: 'Download GREEN18',
    micro: 'Available for iPhone.',
  },

  answer: 'Draft-state valuation is a method of valuing a fantasy football player according to the current state of a specific draft, rather than treating preseason rank or ADP as a fixed measure of player value. It is computed in stages: a baseline projection is converted into a margin over replacement level, that margin is weighted by how fast quality is falling behind the player at his position, adjusted for what the manager gives up by taking him, discounted by the probability he survives to the manager’s next pick, corrected for tier structure rather than rank order, and finally conditioned on the roster already built and the scoring format in force. The eight concepts documented in this section are those stages, not eight alternative theories.',
  ...
  claims: [
    ...
    'Replacement value, positional scarcity, opportunity cost, pick horizon, tier structure, roster construction and scoring format are stages of one valuation rather than competing draft strategies.',
  ...
  blocks: [
    ...
    { type: 'prose', h2: 'How Do the Eight Concepts Fit Together?',
      body: [
        ...
        'Read as a list they look like eight strategies you might choose between. They are not. Skipping one does not simplify the model — it silently substitutes a default, usually a wrong one. A manager who ignores pick horizon has not opted out of it; he has assumed the horizon is zero.',
      ],
      list: [
        ...
        '**Stage 3 — urgency is priced against alternatives.** [Opportunity cost](/draft-science/opportunity-cost) subtracts the value of the best player you decline in order to take this one.',
        '**Stage 4 — the decision is discounted by time.** [Pick horizon](/draft-science/pick-horizon) sets how many selections stand between you and your next turn, which is the length of the risk you accept by waiting.',
        '**Stage 5 — rank is replaced by structure.** [Player tier collapse](/draft-science/player-tier-collapse) corrects for the fact that the board falls in steps, so the cost of waiting is concentrated at a few specific picks rather than spread evenly.',
        '**Stage 6 — the result is conditioned on your team.** [Roster construction](/draft-science/roster-construction) re-weights every position by the starting slots you have already filled and the ones you have not.',
        '**Stage 7 — the format re-prices the pool.** [Superflex quarterback value](/draft-science/superflex-quarterback-value) is the sharpest case of a scoring or lineup rule changing demand without changing supply.',
      ...
      after: [
        'The order is not arbitrary. Scarcity is meaningless before replacement level is defined, because scarcity is a statement about how fast replacement quality is falling. Opportunity cost cannot be priced before scarcity, because the alternatives are what scarcity describes. And none of it is actionable before the pick horizon says how long the board has to stay intact.',
      ],
    },
    ...
    { type: 'prose', h2: 'Why Is Any of This Better Than a Ranking?',
      body: [
        ...
        'A published list is not wrong so much as unfinished. It is correct for an average league, an average roster and an average pick slot — a combination that describes no actual manager on the clock. The eight stages above are the arithmetic a good manager performs in their head between the pick landing and the timer running out.',
  ...
  faq: [
    ...
    { q: 'Are these eight separate draft strategies?', a: 'No. Replacement value, positional scarcity, opportunity cost, pick horizon, tier structure, roster construction and format effects are stages of one valuation. Omitting a stage does not simplify the model; it substitutes a default assumption, such as treating the distance to your next pick as zero.' },
    { q: 'In what order should the concepts be applied?', a: 'Replacement value comes first, because it converts a projection into a comparable margin. Scarcity weights that margin by how fast replacement quality is falling. Opportunity cost prices the alternatives, pick horizon discounts for time, tier structure corrects for step-shaped drops, and roster construction and scoring format condition the result on the specific team and league.' },
